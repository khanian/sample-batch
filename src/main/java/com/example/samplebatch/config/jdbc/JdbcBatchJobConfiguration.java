package com.example.samplebatch.config.jdbc;
...
public class JdbcBatchJobConfiguration {
    ...
    private final JobCompletionNotificationListner jobCompletionNotificationListner;
    ...
    @Bean
    CustomerItemProcessor jdbcItemProcessor() {
